...
def vertex_cells_sum(values, cells):
    ...
    See 'notebook/vectorization_tutorial.ipynb'.

    Input:
    - values : np.array (#cells,) or (#cells, n)
        The cell values to be summed at vertices.
        If shape (#cells,): The value is per-cell,
        If shape (#cells, n): The value is per-cell-vertex. The value (i, j)
        corresponds to cell vertex (i, j)
...
def compute_edges_length(V, E):
    ...
    - E : np.array (#edges, 2)
        The array of mesh edges as generated by the function E = igl.edges(F).
        The i-th row contains the indices of the two vertices of i-th edge.
    Output:
    - l : np.array (#edges,)
        The edge lengths.
    """
...
# -----------------------------------------------------------------------------
#                      2.5.4  Equilibrium energy gradient
# -----------------------------------------------------------------------------
